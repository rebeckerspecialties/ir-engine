...
module.exports = makeMetroConfig({
  ...
  watchFolders: [
    ...
    path.resolve(__dirname, '../../node_modules/clientNative'),
    path.resolve(__dirname, '../../node_modules/@ir-engine/client-core-mobile'),
    path.resolve(__dirname, '../../node_modules/@ir-engine/projects-mobile'),
    ...
    path.resolve(__dirname, '../../node_modules/@ir-engine/network'),
    path.resolve(__dirname, '../../node_modules/@ir-engine/spatial'),
    path.resolve(__dirname, '../../node_modules/@ir-engine/ui'),
    path.resolve(__dirname, '../../node_modules/@ir-engine/xrui'),
  ],
});
